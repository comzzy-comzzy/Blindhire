...
import type { RelayerMetadata, RelayerV1DelegatedUserDecryptPayload, RelayerV1InputProofResponse, RelayerV1PublicDecryptPayload, RelayerV1PublicDecryptResponse, RelayerV1UserDecryptPayload, RelayerV1UserDecryptResponse } from "./payloads.js";
/**
 ...
 */
export declare function requestRelayerV1DelegatedUserDecrypt(relayerProvider: MinimalProvider, payload: RelayerV1DelegatedUserDecryptPayload): Promise<{
    response: RelayerV1UserDecryptResponse[];
}>;
/**
