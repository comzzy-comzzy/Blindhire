...
export declare class FhevmContractsRepository {
    ...
    getCoprocessorContractFromName(name: FhevmHostContractName): FhevmHostContractWrapper;
    getCoprocessorInterfaceFromName(name: FhevmHostContractName): EthersT.Interface;
    get acl(): ACL;
    ...
    getFhevmInstanceConfig(params: {
        chainId: number;
        relayerUrl: string;
    }): Omit<FhevmInstanceConfig, "network"> & {
