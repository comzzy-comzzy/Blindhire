...
(function (FhevmMockProviderType) {
    ...
    FhevmMockProviderType[FhevmMockProviderType["SepoliaEthereumTestnet"] = 4] = "SepoliaEthereumTestnet";
    FhevmMockProviderType[FhevmMockProviderType["EthereumMainnet"] = 5] = "EthereumMainnet";
...
class FhevmMockProvider {
    ...
    get isSepoliaEthereumTestnet() {
        if (!__classPrivateFieldGet(this, _FhevmMockProvider_info, "f")) {
            throw new error_js_1.FhevmError(`the FhevmMockProvider instance is not initialized.`);
        }
        return __classPrivateFieldGet(this, _FhevmMockProvider_info, "f").type === FhevmMockProviderType.SepoliaEthereumTestnet;
    }
    get isEthereumMainnet() {
        if (!__classPrivateFieldGet(this, _FhevmMockProvider_info, "f")) {
            throw new error_js_1.FhevmError(`the FhevmMockProvider instance is not initialized.`);
        }
        return __classPrivateFieldGet(this, _FhevmMockProvider_info, "f").type === FhevmMockProviderType.EthereumMainnet;
    }
...
async function _resolveProviderInfo(minimalProvider, networkName, defaultProviderType, defaultChainId, url) {
    ...
    if (networkName !== "hardhat" &&
        ...
        (defaultChainId === constants_js_1.default.SEPOLIA_ETHEREUM_TESTNET_CHAINID ||
            defaultChainId === constants_js_1.default.ETHEREUM_MAINNET_CHAINID)) {
        (0, error_js_1.assertFhevm)(url !== undefined, "Missing sepolia/mainnet url");
        return {
            type: defaultChainId === constants_js_1.default.ETHEREUM_MAINNET_CHAINID
