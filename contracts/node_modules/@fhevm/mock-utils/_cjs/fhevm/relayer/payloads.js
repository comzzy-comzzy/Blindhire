...
exports.assertIsRelayerV1DelegatedUserDecryptPayload = assertIsRelayerV1DelegatedUserDecryptPayload;
...
function assertIsRelayerV1DelegatedUserDecryptPayload(value) {
    const arrayKeys = ["handleContractPairs", "contractAddresses"];
    const stringKeys = [
        "contractsChainId",
        "publicKey",
    ...
    const objectKeys = ["requestValidity"];
    (0, string_js_1.assertIsStringProperty)(value, stringKeys, "RelayerV1DelegatedUserDecryptPayload");
    (0, error_js_1.assertIsArrayProperty)(value, arrayKeys, "RelayerV1DelegatedUserDecryptPayload");
    (0, error_js_1.assertIsObjectProperty)(value, objectKeys, "RelayerV1DelegatedUserDecryptPayload");
    _assertIsRelayerV1UserDecryptValidity(value.requestValidity);
}
