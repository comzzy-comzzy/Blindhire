...
exports.requestRelayerV1DelegatedUserDecrypt = requestRelayerV1DelegatedUserDecrypt;
...
async function requestRelayerV1DelegatedUserDecrypt(relayerProvider, payload) {
    (0, payloads_js_1.assertIsRelayerV1DelegatedUserDecryptPayload)(payload);
    const response = await (0, provider_js_1.minimalProviderSend)(relayerProvider, methods_js_1.RELAYER_V1_DELEGATED_USER_DECRYPT, [payload]);
    (0, payloads_js_1.assertIsRelayerV1UserDecryptResponse)(response);
    return { response: [response] };
}
