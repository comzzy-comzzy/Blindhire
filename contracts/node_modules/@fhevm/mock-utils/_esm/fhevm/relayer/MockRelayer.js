...
import { FHEVM_CREATE_DECRYPTION_SIGNATURES, FHEVM_GET_CLEAR_TEXT, RELAYER_METADATA, RELAYER_V1_DELEGATED_USER_DECRYPT, RELAYER_V1_INPUT_PROOF, RELAYER_V1_PUBLIC_DECRYPT, RELAYER_V1_USER_DECRYPT, } from "./methods.js";
import { assertIsMockRelayerV1InputProofPayload } from "./mock_payloads.js";
import { assertIsRelayerMetadata, assertIsRelayerV1DelegatedUserDecryptPayload, assertIsRelayerV1InputProofResponse, assertIsRelayerV1PublicDecryptPayload, assertIsRelayerV1PublicDecryptResponse, assertIsRelayerV1UserDecryptPayload, assertIsRelayerV1UserDecryptResponse, } from "./payloads.js";
 ...
 */
export async function requestRelayerV1DelegatedUserDecrypt(relayerProvider, payload) {
