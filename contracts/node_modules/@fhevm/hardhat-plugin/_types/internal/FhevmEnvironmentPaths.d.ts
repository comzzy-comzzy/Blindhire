import { FhevmHostContractName } from "@fhevm/mock-utils";
export declare class FhevmEnvironmentPaths {
     ...
     */
    get fhevmSolidityLibDir(): string;
    /**
     * If using npm:
     ...
     */
    get zamaFheRelayerSdkDir(): string;
    /**
     ...
     */
    resolveFhevmHostContractsArtifactRootDir(): string;
    /**
     * The returned path can be one of the following:
     ...
     */
    resolveFhevmHostContractsArtifactPath(contractName: FhevmHostContractName): string;
    getFhevmHostContractsArtifact(contractName: FhevmHostContractName): Promise<{
        artifact: any;
        path: string;
    }>;
