...
export declare class FhevmEnvironment {
    ...
    resolveRelayerUrl(ACLAddress: string): string;
    private __getAddresses;
    ...
    minimalInitWithAddresses(ignoreCache: boolean): Promise<void>;
    minimalInit(): Promise<void>;
    private __minimalInit;
    private __minimalInitCore;
     ...
     */
    private __initializeAddresses;
    private _initializeAddressesEnv;
    private _initializeAddressesSepolia;
    private _initializeAddressesMainnet;
    private _initializeAddressesMock;
