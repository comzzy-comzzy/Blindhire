...
class FhevmExternalAPI {
    ...
    createDelegatedUserDecryptEIP712(publicKey, contractAddresses, delegatorAddress, startTimestamp, durationDays) {
        return this._fhevmEnv.instance.createDelegatedUserDecryptEIP712(publicKey, contractAddresses, delegatorAddress, startTimestamp, durationDays);
    }
    generateKeypair() {
    ...
    async delegatedUserDecrypt(handleContractPairs, privateKey, publicKey, signature, contractAddresses, delegatorAddress, delegateAddress, startTimestamp, durationDays) {
        if (this._fhevmEnv.isRunningInHHNode) {
            throw new error_1.HardhatFhevmError(`Cannot call delegatedUserDecrypt from a 'hardhat node' server.`);
        }
        return await this._fhevmEnv.instance.delegatedUserDecrypt(handleContractPairs, privateKey, publicKey, signature, contractAddresses, delegatorAddress, delegateAddress, startTimestamp, durationDays);
    }
