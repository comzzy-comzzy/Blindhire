...
async function setupMockUsingHostContractsArtifacts(mockProvider, fhevmAddresses, fhevmSigners, fhevmPaths) {
    ...
    const gatewayDecryptionAddress = (0, addresses_1.getGatewayDecryptionAddress)(fhevmPaths.dotEnvFile);
    const gatewayInputVerificationAddress = (0, addresses_1.getGatewayInputVerificationAddress)(fhevmPaths.dotEnvFile);
    const gatewayChainId = constants_1.default.ZAMA_FHE_RELAYER_SDK_PACKAGE.sepolia.gatewayChainId;
    const kmsInitialThreshold = (0, addresses_1.getKMSThreshold)(fhevmPaths.dotEnvFile);
    const inputVerifierInitialThreshold = (0, addresses_1.getInputVerifierThreshold)(fhevmPaths.dotEnvFile);
